...
def show(screen: pygame.Surface):
    ...
    Returns:
        (str, Settings.Menu), exit code and Settings.Menu object
    """
    ...
    mute = Button(screen, "", mg_settings.active_bt_color, mg_settings.inactive_bt_color,mg_settings.bt_text_color, mg_settings.lvl_button_width, mg_settings.lvl_button_height, (0,0))
    #
    ...
    def update_screen():
        ...
        mute.mute(mg_settings.is_muted)
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                for button in {lvl1_button,lvl2_button,lvl3_button}:
                    if button.rect.collidepoint(pos):
                        return button.org_msg, mg_settings
                
                if mute.rect.collidepoint(pos):
                    mute.clear()
                    if mg_settings.is_muted:
                        mg_settings.is_muted = False
                    else:
